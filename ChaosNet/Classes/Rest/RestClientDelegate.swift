...
public protocol RestClientDelegate: AnyObject {
    ...
    func restClient(_ restClient: RestClient, willSend request: RestRequest, relativeTo url: URL?)

    /// Tells the delegate to perform a pre request before sending the actual request.
    ///
    func restClient(_ restClient: RestClient, performPreRequestFor request: RestRequest, relativeTo url: URL?) async throws
    ...
    func restClient(_ restClient: RestClient, didSend request: RestRequest, relativeTo url: URL?)
    ...
    func restClient(_ restClient: RestClient, acceptsResponse response: RestTransportEngineResponse, forRequest request: RestRequest, relativeTo url: URL?) -> Bool
    ...
    func restClient(_ restClient: RestClient, shouldRescueRequest request: RestRequest, withResponse response: RestTransportEngineResponse, relativeTo url: URL?) -> Bool
    ...
    func restClient(_ restClient: RestClient, rescueRequest request: RestRequest, withResponse response: RestTransportEngineResponse, relativeTo url: URL?) async throws -> RestTransportEngineResponse

    /// Tells the delegate, that the client has produced successfully a response for the user of the client.
    func restClient<D>(_ restClient: RestClient, didProduceRestResponse restReponse: RestResponse<D>, forRequest request: RestRequest, relativeTo url: URL?)
...
public extension RestClientDelegate {
    ...
    func restClient(_ restClient: RestClient, sendingRequestDidFailWithError error: Error, forRequest request: RestRequest, relativeTo url: URL?) {}
    func restClient(_ restClient: RestClient, didSend request: RestRequest, relativeTo url: URL?) {}
    func restClient(_ restClient: RestClient, acceptsResponse response: RestTransportEngineResponse, forRequest request: RestRequest, relativeTo url: URL?) -> Bool { true }
    func restClient(_ restClient: RestClient, shouldRescueRequest request: RestRequest, withResponse response: RestTransportEngineResponse, relativeTo url: URL?) -> Bool { false }
    func restClient(_ restClient: RestClient, rescueRequest request: RestRequest, withResponse response: RestTransportEngineResponse, relativeTo url: URL?) async throws -> RestTransportEngineResponse { response }
    func restClient<D>(_ restClient: RestClient, didProduceRestResponse restReponse: RestResponse<D>, forRequest request: RestRequest, relativeTo url: URL?) {}
    func restClient(_ restClient: RestClient, responseProcessingDidFailWithError error: Error, forRequest request: RestRequest, relativeTo url: URL?) {}
}
